...
void initialize_stack(SwitchStack *stack) { stack->top = -1; }

// Function to check if the stack is empty
bool is_empty(SwitchStack *stack) { return stack->top == -1; }

// Function to check if the stack is full
bool is_full(SwitchStack *stack) { return stack->top >= MAX_STACK_SIZE - 1; }
